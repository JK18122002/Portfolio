        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I believe tecnology should be a bridge that connects people and solves real-world problems. My passions lies in crafting digital experiences that are not just functional, but delightful and accessible to evryone.
              </p>
              <p
              ...
              <div className="grid gap-4">
                {PASSIONS.map((passion, index)=> (
                  ...
                  className={`flex items-center space-x-4 p-4 rounded-xl ${
                    ...
                    : "bg-gray-50/50 hover:bg-gary-100/50"
                  } transition-all duration-300`}
                  >
                    <div
                    className={`p-3 ronded-lg ${
            ...
            className="text-center py-8">
              ...
              <div className="flex justify-center">
                <img src={SIGNATURE} alt="JK"  className="w-28" />
              </div>
